...
CPPFLAGS        := -I$(INCLUDEDIR) -Istar
LDFLAGS         := -lstar-api -lstar_conf_api_mk2 -lstar_conf_api_brick_mk2 -lstar_conf_api_brick_mk3 -lstar_conf_api_pci_mk2 -lstar-api -lrmap_packet_library -lpthread
SOURCES         := $(wildcard *.c)
#SOURCES         := $(wildcard *.c)
